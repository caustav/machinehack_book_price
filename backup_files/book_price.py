...
X_train, X_test, y_train, y_test = train_test_split(
    X_main, y, test_size=0.2, random_state=123)
...
_title = adjust_test_cols(title, _title)
_author = adjust_test_cols(author, _author)
_bindtype = adjust_test_cols(bindtype, _bindtype)
_year = adjust_test_cols(year, _year)
_genre = adjust_test_cols(genre, _genre)
_category = adjust_test_cols(category, _category)
